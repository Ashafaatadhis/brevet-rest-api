...
const paginationAdmin = (page, count) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield prisma_1.default.userAnswer.findMany({
        where: {
            deletedAt: {
                isSet: false,
            },
    ...
    const dataCount = yield prisma_1.default.userAnswer.count({
        where: {
            deletedAt: {
                isSet: false,
            },
    ...
    const hasNext = yield prisma_1.default.userAnswer.findMany({
        take: 1,
        skip: count * (page + 1 - 1),
        where: {
            deletedAt: {
