...
const paginationAdmin = (page, count) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield prisma_1.default.pG.findMany({
        where: {
            deletedAt: {
                isSet: false,
            },
    ...
    const dataCount = yield prisma_1.default.pG.count({
        where: {
            deletedAt: {
                isSet: false,
            },
    ...
    const hasNext = yield prisma_1.default.pG.findMany({
        take: 1,
        skip: count * (page + 1 - 1),
        where: {
            deletedAt: {
...
const paginationUser = (page, count, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const { courseId } of getCoursePurchased) {
        data = yield prisma_1.default.pG.findMany({
            where: {
                courseFolder: {
                    course: {
                        id: courseId,
        ...
        dataCount = yield prisma_1.default.pG.count({
            where: {
                courseFolder: {
                    course: {
                        id: courseId,
        ...
        hasNext = yield prisma_1.default.pG.findMany({
            take: 1,
            skip: count * (page + 1 - 1),
            where: {
                courseFolder: {
