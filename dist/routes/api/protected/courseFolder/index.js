...
const getCurrentCourseFolder_1 = __importDefault(require("../../../../controller/protected/courseFolder/getCurrentCourseFolder"));
...
router.get("/current", (0, errorHandler_1.default)(getCurrentCourseFolder_1.default));
