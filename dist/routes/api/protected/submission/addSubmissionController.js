...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (errors.isEmpty()) {
        ...
        try {
            const urlImage = yield (0, uploadFile_1.uploadMultiple)(req, "courseTaskFile");
            if (!urlImage) {
            ...
            const newData = urlImage.map((value) => {
                return Object.assign(Object.assign({}, value), { courseTaskId: req.body.courseTaskId });
            });
            console.log(newData);
            yield prisma_1.default.courseTaskFile.createMany({
                data: [...newData],
            });
