...
router.post("/", validator_1.addCourseValidator, (0, errorHandler_1.default)(submission_1.addSubmissionController));
router.put("/:id", validator_1.addCourseValidator, (0, errorHandler_1.default)(submission_1.editSubmissionController));
