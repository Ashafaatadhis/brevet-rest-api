...
router.post("/", multerFile_1.default.single("image"), validator_1.addBatchValidator, (0, errorHandler_1.default)(batch_1.addBatchController));
router.get("/search", (0, errorHandler_1.default)(batch_1.searchBatchController));
router.put("/:id", multerFile_1.default.single("image"), validator_1.editBatchValidator, (0, errorHandler_1.default)(batch_1.editBatchController));
